...
const dadosIniciais = {
    usuarios: [
        { "id": generateUUID (), "login": "admin", "senha": "123", "nome": "Administrador do Sistema", "email": "admin@abc.com", "sexo": "Masculino", "data": "18/04/1994",
                                 "cidade": "Betim", "estado": "MG"},
        { "id": generateUUID (), "login": "user", "senha": "123", "nome": "Usuario Comum", "email": "user@abc.com", "sexo": "Feminino", "data": "17/02/2002", 
...
function loginUser (login, senha) {
    ...
    for (var i = 0; i < db_usuarios.usuarios.length; i++) {
        ...
        if (login == usuario.login && senha == usuario.senha) {
            ...
            usuarioCorrente.data = usuario.data;
...
function addUser (nome, login, senha, email, sexo, data, cidade, estado) {
    
    // Cria um objeto de usuario para o novo usuario 
    let newId = generateUUID ();
    let usuario = { "id": newId, "login": login, "senha": senha, "nome": nome, "email": email, "sexo": sexo, "data": data, "cidade": cidade, "estado": estado };
